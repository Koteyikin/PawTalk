...
@section('body')
    <div class="grid grid-rows-6 grid-cols-1  bg-local">

        <div class="grid grid-cols-12 grid-rows-9 gap-4 rounded-xl bg-dark bg-[--custom] ">
        ...
        <div class="grid grid-cols-12 grid-rows-7 gap-1 bg-white ">
        ...
        <div class="grid grid-cols-12 grid-rows-8 gap-1 bg-white">
            <div class="col-span-6 col-start-4">Лента активностей</div>
